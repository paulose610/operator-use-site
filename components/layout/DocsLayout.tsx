...
import { navSections as setupNavSections, allNavIds as setupAllNavIds } from "@/lib/content/navigation";
...
export default function DocsLayout({ children, navSections, allNavIds }: Props) {
  const sections = navSections ?? setupNavSections;
  const ids = allNavIds ?? setupAllNavIds;
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex max-w-[1200px] mx-auto w-full">
        ...
        <div className="w-56 shrink-0 border-r border-[var(--border)] px-4">
          <Sidebar navSections={sections} allNavIds={ids} />
        </div>
